...
with(this){return _c('ol',[_c('li',[_v("User chooses to add a new student.")]),_v(" "),_c('li',[_v("User enters the required details to create a student.")]),_v(" "),_c('li',[_v("TutorMate creates the student.")]),_v(" "),_c('li',[_v("The app shows the user the new student created.")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. Some required details are missing and / or incorrect.\n"),_c('ul',[_c('li',[_v("2a1. The app informs the user of the error")]),_v(" "),_c('li',[_v("2a2. The app requests for the correct data.")]),_v(" "),_c('li',[_v("2a3. The user enters new data.")]),_v(" "),_c('li',[_v("Steps 2a2 - 2a3 are repeated until the data entered is correct.")]),_v(" "),_c('li',[_v("Use case resumes from step 2.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to list students")]),_v(" "),_c('li',[_v("TutorMate shows a list of students")]),_v(" "),_c('li',[_v("User requests to see a specific student")]),_v(" "),_c('li',[_v("TutorMate shows the student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User requests to find a student by a specific characteristic e.g. Name")]),_v(" "),_c('li',[_v("TutorMate shows a list of students that match the user's input")]),_v(" "),_c('li',[_v("User "),_c('u',[_v("shows a student (UC04)")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to list students")]),_v(" "),_c('li',[_v("User chooses to edit a student and enters the required data")]),_v(" "),_c('li',[_v("TutorMate edits the student's details")]),_v(" "),_c('li',[_v("TutorMate shows the edited student's details")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. Some required details are missing and / or incorrect.\n"),_c('ul',[_c('li',[_v("2a1. The app informs the user of the error")]),_v(" "),_c('li',[_v("2a2. The app requests for the correct data.")]),_v(" "),_c('li',[_v("2a3. The user enters new data.")]),_v(" "),_c('li',[_v("Steps 2a2 - 2a3 are repeated until the data entered is correct.")]),_v(" "),_c('li',[_v("Use case resumes from step 2.")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"use-case-see-a-day-s-schedule-uc07"}},[_v("Use case: See a day's schedule [UC07]"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-see-a-day-s-schedule-uc07","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to see a day's schedule (today, or any day)")]),_v(" "),_c('li',[_v("TutorMate shows that day's schedule")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Thu, 9 Nov 2023, 22:15:29 GMT+8]")])])])}
}];
