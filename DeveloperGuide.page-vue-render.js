...
with(this){return _c('p',[_v("Inside the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" component, there are 3 main components: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Prerequisites:")]),_v(" "),_c('ul',[_c('li',[_v("List all students using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list students")]),_v(" command.")]),_v(" "),_c('li',[_v("There are currently four students with names \"Alex Wong\", \"Alex Yeoh\", \"Willy Wonka\" and \"Wong Max\". "),_c('br'),_c('br')])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find Alex")]),_v(" "),_c('br'),_v("\nExpected: Only students with the name \"Alex Wong\" and \"Alex Yeoh\" are shown. A message indicating the number of students listed is shown in the response box.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find won")]),_v(" "),_c('br'),_v("\nExpected: Only students with the name \"Alex Wong\", \"Willy Wonka\"  and \"Wong Max\" are shown. A message indicating the number of students listed is shown in the response box.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find xyz")]),_v(" "),_c('br'),_v("\nExpected: No students are shown. A message indicating 0 persons listed is shown in the response box.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Prerequisites:")]),_v(" "),_c('ul',[_c('li',[_v("List all lessons using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command.")]),_v(" "),_c('li',[_v("There are currently three lessons with names \"Chemistry Lesson at bedok\", \"lesson chem at kovan\" and \"bedok eng\". "),_c('br'),_c('br')])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find chem")]),_v(" "),_c('br'),_v("\nExpected: Only lessons with the name \"Chemistry Lesson at bedok\" and \"lesson chem at kovan\" are shown. A message indicating the number of lessons listed is shown in the response box.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find bedok")]),_v(" "),_c('br'),_v("\nExpected: Only students with the name \"Chemistry Lesson at bedok\" and \"bedok eng\" are shown. A message indicating the number of lessons listed is shown in the response box.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find x")]),_v(" "),_c('br'),_v("\nExpected: No lessons are shown. A message indicating 0 lessons listed is shown in the response box.")])])])}
},function anonymous(
) {
