...
with(this){return _c('li',[_c('strong',[_v("Configure the JDK")]),_v(": Follow the guide "),_c('a',{attrs:{"href":"https://se-education.org/guides/tutorials/intellijJdk.html"}},[_c('em',[_v("[se-edu/guides] IDEA: Configuring the JDK")])]),_v(" to ensure Intellij is configured to use "),_c('strong',[_v("JDK 11")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('li',[_c('p',[_c('strong',[_v("Learn the design")])]),_v(" "),_c('p',[_v("When you are ready to start coding, we recommend that you get some sense of the overall design by reading about "),_c('a',{attrs:{"href":"/tp/DeveloperGuide.html#architecture"}},[_v("TutorMate’s architecture")]),_v(".")])])}
},function anonymous(
) {
