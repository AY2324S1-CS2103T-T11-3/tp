...
with(this){return _c('ul',[_c('li',[_v("Shows the list and associated detail panel for the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("[LIST]")]),_v(".")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("[KEYWORDS]")]),_v(" parameter is for specifying which student details to display, and is only valid for 👨‍🎓 "),_c('em',[_c('strong',[_v("STUDENTS list")])]),_v(". The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("[KEYWORDS]")]),_v(" parameter can only be used after "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list students")]),_v(". When used for 📅 "),_c('em',[_c('strong',[_v("SCHEDULE list")])]),_v(" and 💼 "),_c('em',[_c('strong',[_v("TASKS list")])]),_v(", they will be ignored.")]),_v(" "),_c('li',[_v("Refer to the parameter constraints "),_c('a',{attrs:{"href":"#parameter-summary"}},[_v("here")]),_v(".")])])}
},function anonymous(
) {
