...
with(this){return _c('li',[_v("Edits the lesson at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("INDEX")]),_v(" if it is provided, otherwise edits the currently/lastly shown lesson.")])}
},function anonymous(
) {
with(this){return _c('li',[_v("Please note that unlike the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addLesson")]),_v(" command, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("editLesson")]),_v(" command's \"-subject\" flag only accepts one subject, not multiple subjects (parameter is SUBJECT, not SUBJECTS).")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Tips:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("If you are currently in "),_c('em',[_c('strong',[_v("SCHEDULE list")])]),_v(", the command can be shortened to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit")]),_v(".")])])}
},function anonymous(
) {
...
with(this){return _c('li',[_v("Refer to the parameter constraints "),_c('a',{attrs:{"href":"#parameter-summary"}},[_v("here")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Tips:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("When filtering by multiple fields, only the students which match all the fields are returned.")]),_v(" "),_c('li',[_v("To reset the view to an unfiltered state, type "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list students")]),_v(".")]),_v(" "),_c('li',[_v("If no students that match the filters are found, an empty list will be shown.\n")])])}
},function anonymous(
) {
